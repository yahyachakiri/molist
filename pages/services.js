...
export default function services({headerMenus, ProjectsCategory, projects, projectsContent, contactContent}) {
    const [projectCategory,  setProjectCategory] = useState('all');
    return (
        <>
        <Header headerMenus={headerMenus} />
        <div className='bg-white pb-6'>
            <ArticleHeader title='services' image={imgValue(projectsContent, 'banner')} white />
            ...
            <h1 className="uppercase text-4xl sm:text-5xl">
                ...
                <span className="font-helveticaneue-black">
                    Your
                    <br />
                    Imagination
                </span>
