            ...
            <Container className='flex items-center justify-between px-4'>
                ...
                <div className="z-50 flex items-center gap-6">
                    <Link href='cart' className="group relative">
                        ...
                        {
                            items.length > 0 &&
                            <span className='absolute top-[-10px] right-[-10px] bg-mainSecond h-[24px] min-w-[24px] flex justify-center items-center rounded-full font-[Teko] font-medium'>{items.length}</span>
                        }
                    </Link>
